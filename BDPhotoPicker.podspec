#
#  Be sure to run `pod spec lint BDPhotoPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "first test pod A simple photopicker controller"

  s.homepage     = "http://github.com/jianbinking/BDPhotoPicker"
